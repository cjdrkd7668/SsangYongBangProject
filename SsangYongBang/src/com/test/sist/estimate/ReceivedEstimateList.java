	   ...
	   n = ((nowPage - 1) / blockSize) * blockSize + 1;
		...
		if (n == 1) {
			...
			pagebar += String.format("<li>"
					+ "            <a href=\"/sybang/estimate/receivedestimatelist.do?page=%d\" aria-label=\"Previous\">"
					+ "                <span aria-hidden=\"true\">&laquo;</span>"
					+ "            </a>"
					+ "        </li>", n - 1);
		}
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			pagebar += String.format("<a href=\"/sybang/estimate/receivedestimatelist.do?page=%d\">%d</a></li>", n, n);
		...
		if (n > totalPage) {
			...
			pagebar += String.format("<li>"
					+ "            <a href=\"/sybang/estimate/receivedestimatelist.do?page=%d\" aria-label=\"Next\">"
					+ "                <span aria-hidden=\"true\">&raquo;</span>"
					+ "            </a>"
					+ "        </li>", n);

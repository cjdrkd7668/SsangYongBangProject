...
@WebServlet("/servicescheduler/writeschedule.do")
public class WriteSchedule extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/servicescheduler/writeschedule.jsp");

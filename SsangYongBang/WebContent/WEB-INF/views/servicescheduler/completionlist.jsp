...
<body>
   ...
   <!-- 본문 상단 끝 -->
	...
	<div class="chatlistHeader">서비스완료 정보를 입력할 고객 명단</div>
	<ul class="chatgroup">
		<c:forEach items="${list}" var="dto">

		<li class="servicelist"> 
					<!-- 업체승인번호는 세션 안에 담아두었으니 견적서번호만 가지고 가도 조회 가능 -->
			<a href="/sybang/servicescheduler/writecompletion.do?estimate1thSeq=${dto.estimate1thSeq}">
			${dto.memberName}님&nbsp;&nbsp;<span class="badge">미등록</span>
			</a>
		</li>

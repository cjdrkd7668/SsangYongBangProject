...
<body>
   ...
   <!-- 본문 상단 끝 -->
		...
		<div class="wrapper">
			...
			<form method="POST" action="/sybang/servicereview/writereviewok.do" enctype="multipart/form-data">
	
			<div class="content serveceInfo">
				<label>후기내용</label>
				<input type="text" name="content" class="form-control">
			</div>
			<div class="contentURL serveceInfo">
				<label>후기 사진</label><input type="file" name="contentURL" id="file" class="form-control" placeholder="file">
			</div>
		</div>	
		...
		<input type="hidden" name="completionSeq" value="${completionSeq}"> 

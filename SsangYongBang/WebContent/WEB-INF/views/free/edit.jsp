...
<body>
    ...
    <div class="detailContainer">
        ...
        <div class="page-header">
            <h1><strong>자유게시판 <i class="fas fa-chalkboard-teacher blue"></i>&nbsp;&nbsp;&nbsp;</strong><small>수정 후 등록하기 버튼을 눌러주세요.</small>
            </h1>
            <div class="divider"></div>
        </div>
        
        <!-- form 태그 시작 -->
        <form method="POST" action="/sybang/free/editok.do">
        <!-- detailTable 시작 -->
            ...
            <tr>
                <td colspan="3">
                    ...
                    <div class="btns btn-group">
                        ...
                        <button type="button" class="btn btn-default" onclick="location.href='/sybang/free/detail.do?seq=${dto.seq}';">
